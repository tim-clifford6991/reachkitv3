...
its denominator carried beside every count.
...
## NFR budget
- Free path spend: `keyword_suggestions` 1.8¢ + 12 live SERPs 2.4¢ + **two** nano
  calls ≈ 0.6¢ (see Decisions 2) — inside `CAPS.FREE_C` 12¢.
