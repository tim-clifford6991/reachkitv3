...
status: approved
satisfies: []
covers: [REQ-001, REQ-004, REQ-006, REQ-008, REQ-009, REQ-010, REQ-020, REQ-021, REQ-024, REQ-025, REQ-026, REQ-028, REQ-029, REQ-040, REQ-041, REQ-043, REQ-045, REQ-057, REQ-070, REQ-078, REQ-094]
...
ADR-091); these seven are anchored by this container's own glob and by nothing
...
None of these is a candidate for a new feature node. Six are transport-only
adapters, which decision 1 fixes as this container's without exception; the
seventh, `/pricing`, is a rendered surface whose every input is another node's
