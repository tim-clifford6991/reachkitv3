...
//
// The module's public entry point. Re-exports `COPY`, `COPY_META`, `copy`,
// `explain` and the types `CopyKey`, `CopyMeta`, `CopyPartition`,
// `ExplainKey`, `MeasuredSlotOf` — nothing else. No partition is
